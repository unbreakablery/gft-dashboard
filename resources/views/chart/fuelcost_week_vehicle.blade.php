    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="d-flex flex-sm-fill h3 my-2 text-primary align-items-center font-w700">
                ...
                <span class="">Fuel Cost Per Week By Vehicle</span>
            </h1>
        </div>
    </div>
</div>
    ...
    function initialData() {
        ...
        for (let i = 0; i < categories.length; i++) {
            ...
            for (let j = 0; j < weeks.length; j++) {
                if (weeks[j].week == categories[i]) {
                    sum_cost += weeks[j].cost;
                }
            }
            average.push(Math.round(sum_cost / vehicles.length * 100) / 100);
        }
        ...
        for (let i = 0; i < vehicles.length; i++) {
            ...
            if (i == 0) {
                ...
                pie_data.push([vehicles[i], sum_cost]);
            }
